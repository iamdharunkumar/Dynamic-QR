...
import { Route as DashboardQrIdRouteImport } from './routes/dashboard/qr/$id'
...
const DashboardQrIdRoute = DashboardQrIdRouteImport.update({
  id: '/qr/$id',
  path: '/qr/$id',
  getParentRoute: () => DashboardRoute,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/dashboard/qr/$id': typeof DashboardQrIdRoute
}
...
export interface FileRouteTypes {
  ...
  to: '/' | '/login' | '/dashboard/create' | '/dashboard' | '/dashboard/qr/$id'
  id:
    | '__root__'
    | '/'
    | '/dashboard'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/dashboard/qr/$id': {
      ...
      preLoaderRoute: typeof DashboardQrIdRouteImport
      parentRoute: typeof DashboardRoute
    }
  }
}
...
interface DashboardRouteChildren {
  ...
  DashboardQrIdRoute: typeof DashboardQrIdRoute
}

const DashboardRouteChildren: DashboardRouteChildren = {
  DashboardCreateRoute: DashboardCreateRoute,
  DashboardIndexRoute: DashboardIndexRoute,
  DashboardQrIdRoute: DashboardQrIdRoute,
}
